...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <div class="navbar-block">
                        <a href="/logout" class="btn btn-danger btn-sm mt-0 mb-2 pl-3 pr-3">Log Out <i
        ...
        <aside class="main-sidebar sidebar-dark-light elevation-8">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('template/dist/img/lappland.jpg') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                        <label style="color: white;" for="name">{{ Auth::user()->name }}</label>
                    </div>
                </div>
        ...
        <footer class="main-footer pb-1 pt-1">
            <strong>Copyright &copy; 2022-2023 <a href="/"><b>Kyaa The Chen</b></a>.</strong>
            All rights reserved.
